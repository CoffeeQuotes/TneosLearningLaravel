        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="p-2 single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="400ms" style="border-radius: 50px;
                ...
                <!-- Single Testimonials Area -->
                <div class="col-12 col-md-6">
                    <div class="p-2 single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="500ms" style="border-radius: 50px;
                    background: linear-gradient(145deg, #b6d8df, #d8ffff);
                    box-shadow:  20px 20px 60px #acccd3,
                                 -20px -20px 60px #e8ffff;">
                        <div class="testimonial-thumb">
                ...
                <!-- Single Testimonials Area -->
                <div class="col-12 col-md-6">
                    <div class="p-2 single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="600ms" style="border-radius: 50px;
                    background: linear-gradient(145deg, #b6d8df, #d8ffff);
                    box-shadow:  20px 20px 60px #acccd3,
                                 -20px -20px 60px #e8ffff;">
                        <div class="testimonial-thumb">
                ...
                <!-- Single Testimonials Area -->
                <div class="col-12 col-md-6">
                    <div class="p-2 single-testimonial-area mb-100 d-flex wow fadeInUp" data-wow-delay="700ms" style="border-radius: 50px;
                    background: linear-gradient(145deg, #b6d8df, #d8ffff);
                    box-shadow:  20px 20px 60px #acccd3,
                                 -20px -20px 60px #e8ffff;">
                        <div class="testimonial-thumb">
