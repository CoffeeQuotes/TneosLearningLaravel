                        ...
                        <div class="card life-card mb-4 shadow-lg" style="width: 12.5rem;">
                            ...
                            <div class="card-body descripiton-card">
                                  ...
                                  <div class="d-flex justify-content-start">
                                    ...
                                    <div class="ml-1 d-flex content-justify-center">
                                        <p class="p-0 m-0" style="font-size: 11px; color: #73726c;">{{$life->board}}</p>
                                        <p class="p-0 px-2 m-0" style="font-size: 11px; color: #73726c;">{{$life->subject}}</p>
                                        <p class="p-0 m-0"  style="font-size: 11px; color: #73726c;">{{$life->created_at->diffForHumans()}}</p>
                                    </div>
                                </div>
                                </div>
