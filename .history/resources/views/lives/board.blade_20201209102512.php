                        ...
                        <div class="card life-card mb-4 shadow-lg" style="width: 12.5rem;">
                            ...
                            <div class="card-body descripiton-card">
                                  ...
                                  <div class="d-flex justify-content-start">
                                    ...
                                    <div>
                                    <div class="card-title mb-0 videotitle text-info p-1">{{\Illuminate\Support\Str::limit($life->title, 100, $end='...')}}</div>
                                    <div>
                                        <p class="p-0 m-0">{{$life->board}}</p>
                                        <p class="p-0 m-0">{{$life->subject}}</p>
                                    </div>
                                </div>
                                </div>
