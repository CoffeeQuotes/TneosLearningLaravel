...
<div class="container" style="min-height: 100vh">
        ...
        <lottie-player src="https://assets7.lottiefiles.com/datafiles/K6S8jDtSdQ7EPjH/data.json" background="transparent"  style="width: 60%; height:60%;" speed="1"  loop autoplay></lottie-player>
        <h1>Thank you, Your Crash Course Will be available to you very soon!</h1>
    </div>
