...
<head>
    ...
    <title>Free Trial ClassesCapsule - Tneos Eduloution</title>
...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-2 mx-auto my-2">
        ...
        <p class="lead font-weight-normal">Free Trial Classes Download Now</p>
    </div>
</div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-check">
                    ...
                    <label class="form-check-label" for="exampleCheck1" >I would like to receive updates regarding my FREE class</label>
                     ...
                     <input type="hidden" name="type" value="Free Trial ClassesCapsule 2020" />
...
/></noscript>
<!-- End FacTrial ClassesPixel Code -->
</script>
</body>
</html>
