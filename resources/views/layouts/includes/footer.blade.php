            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget mb-100">
                        ...
                        <p>Tneos Eduloutions Ltd is a registered and licensed online educational service provider corporate that is based in New Delhi – India.</p>
                        <div class="footer-social-info">
                            <a href="https://www.facebook.com/tneoslearning/"><i class="fa fa-facebook"></i></a>
                            <a href="https://twitter.com/TneosL"><i class="fa fa-twitter"></i></a>
                            <!--<a href="#"><i class="fa fa-dribbble"></i></a>-->
                            <!--<a href="#"><i class="fa fa-behance"></i></a>-->
                            <a href="https://www.instagram.com/tneoslearning"><i class="fa fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
                <!-- Footer Widget Area -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget mb-100">
                        ...
                        <div class="gallery-list d-flex justify-content-between flex-wrap">
                            <a href="{{ url('/') }}/storage/{{setting('site.gallery_img_i')}}" class="gallery-img" title="Gallery Image 1"><img src="{{ url('/') }}/storage/{{setting('site.gallery_img_i')}}" alt=""></a>
                            <a href="{{ url('/') }}/storage/{{setting('site.gallery_img_ii')}}" class="gallery-img" title="Gallery Image 2"><img src="{{ url('/') }}/storage/{{setting('site.gallery_img_ii')}}" alt=""></a>
                            <a href="{{ url('/') }}/storage/{{setting('site.gallery_img_iii')}}" class="gallery-img" title="Gallery Image 3"><img src="{{ url('/') }}/storage/{{setting('site.gallery_img_iii')}}" alt=""></a>
                            <a href="{{ url('/') }}/storage/{{setting('site.gallery_img_iv')}}" class="gallery-img" title="Gallery Image 4"><img src="{{ url('/') }}/storage/{{setting('site.gallery_img_iv')}}" alt=""></a>
                            <a href="{{ url('/') }}/storage/{{setting('site.gallery_img_v')}}" class="gallery-img" title="Gallery Image 5"><img src="{{ url('/') }}/storage/{{setting('site.gallery_img_v')}}" alt=""></a>
                            <a href="{{ url('/') }}/storage/{{setting('site.gallery_img_vi')}}" class="gallery-img" title="Gallery Image 6"><img src="{{ url('/') }}/storage/{{setting('site.gallery_img_vi')}}" alt=""></a>
                        </div>
                    </div>
                </div>
                <!-- Footer Widget Area -->
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget mb-100">
                        ...
                        <div class="single-contact d-flex mb-30">
                            ...
                            <p>L323, Mahipalpur Extension, New Delhi-110037, India</p>
                        </div>
                        <div class="single-contact d-flex mb-30">
                            <i class="icon-telephone-1"></i>
                            <p>Main: (+91) {{setting('site.customer_care')}} <br>Office: (+91) {{setting('site.customer_care')}}</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group"><label for="form_email" style="color: #5f6368;">Phone <span class="text-danger">*</span></label> <input
                                        ...
                                        data-error="Valid phone is required." pattern="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$" style="border: 0;"></div>
                            </div>
