                ...
                <div class="classy-menu" style="background-color: #333333;">
                    ...
                    <div class="classynav">
                        ...
                        <div class="dropdown" style="background-color: #333333;">
                            ...
                            <div class="dropdown-menu text-wrap" aria-labelledby="dropdownMenuButton" style="background-color: #333333;">
                                <a class="dropdown-item" href="/board/CBSE"><img width="24px" src="{{asset('app-assets/img/core-img/CBSE.jpg')}}" alt="">&nbsp;CBSE Board</a>
                                <a class="dropdown-item" href="/board/Bihar"><img width="24px" src="{{asset('app-assets/img/core-img/biharboardlogo.jpg')}}" alt="">&nbsp;Bihar Board</a>
                                <a class="dropdown-item" href="/board/Odisha"><img width="24px" src="{{asset('app-assets/img/core-img/Bse.odisha.logo.jpg')}}" alt="">&nbsp;Odisha Board</a>
                                <a class="dropdown-item" href="/board/MP"><img width="24px" src="{{asset('app-assets/img/core-img/mpboard.jpg
')}}" alt="">&nbsp;MP Board</a>
...
')}}" alt="">&nbsp;MP Board</a>
                        ...
                        <!--<a href="/posts" class="pl-2">Blog <img src="https://img.icons8.com/color/48/000000/new--v1.png" width="24"/></a>-->
                        <a href="https://shop.tneos.com" class="pl-2">Shop <img src="https://img.icons8.com/fluent/48/000000/favorite-cart.png" width="22"/></a>
                        <ul>
                            <li>
                                <a type="button" style="background-color: #333333;"  data-toggle="modal" data-target="#exampleCenter">
                                    Contact Us
                                </a>
                        </ul></li>
                        {{-- <ul>
