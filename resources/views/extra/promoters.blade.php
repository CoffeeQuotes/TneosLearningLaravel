...
<section class="snow_again">
     <div class="jumbotron malibu_beach" style="background-color: #ffe817; background-blend-mode: multiply; border-radius: 0; border-bottom-left-radius: 100%;  border-bottom-right-radius: 100%; ">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 style="color: white!important; letter-spacing: 2px;">Our Promoters</h2>
                    <p class="lead text-white-50">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                </div>
                <div class="col">
     ...
     <div class="container">
         <div class="py-5" style="background-color: rgb(255,255,255); background: linear-gradient(to left top, rgba(255,255,255,0.8), rgba(255,255,255,0.2)); border-radius: 2rem; z-index: 2; backdrop-filter: blur(2rem);">
            <div class="row py-2 px-4">
                <div class="col py-5 px-4">
                    <h2 class="my-5">Lorem ipsum dolor sit amet</h2>
                    <p class="font-weight-lighter font-serif">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A accusamus at consequatur enim incidunt maiores maxime officia qui. A esse id ipsam nemo officia quis repellat saepe unde veritatis vero!</p>
                </div>
                <div class="col">
                    <img class="rounded-circle" src="{{"app-assets/img/core-img/promoters-comp.png"}}" alt="tneos promoters" style="border: 16px solid rgba(255,255,255,0.8); box-shadow: 6px 6px 12px #aaaaaa;">
                </div>
            </div>
        </div>
     </div>
         <section class="teachers-area section-padding-0-100">
             <div class="container">
                 ...
                 <div class="container bg-white section-padding-100">
                     <div class="row">
                         <div class="col-md-4">
                         ...
                         <div class="col-md-8">
                             ...
                             <p>Neeru is a <b>Post Graduate (M.Sc.)</b> from <i><strong>Dehradun University</strong></i> in Physics and a <b>DOEACC-A Level &amp; PGDCST</b>
                     ...
                     <div class="row mt-100">
                         ...
                         <div class="col-md-8">
                             ...
                             <span class="text-uppercase" style="font-weight: bolder; margin-bottom: 50px!important;">Director Education Strategy, M.Sc. (Physics)</span>
                             <p>Arun brings in experience and expertise from an incubating eco-system having been part of a series of
